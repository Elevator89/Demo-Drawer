#include "../Color.h"
#include "../ColorUtil.h"
#include "QueuePopWithChanceDrawer.h"

QueuePopWithChanceDrawer::QueuePopWithChanceDrawer(const ITopology* topology, IColorGenerator* colorGenerator, float chanceToUsePoppedItem, float fieldFillBeforeFlush) :
	m_topology(topology),
...
QueuePopWithChanceDrawer::~QueuePopWithChanceDrawer() {}

void QueuePopWithChanceDrawer::Draw(Field<uint32_t>& field)
{
...
bool QueuePopWithChanceDrawer::TryPushPoint(const Point& point)
{
