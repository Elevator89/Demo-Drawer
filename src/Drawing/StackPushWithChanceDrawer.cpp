#include "../Color.h"
#include "../ColorUtil.h"
#include "StackPushWithChanceDrawer.h"

StackPushWithChanceDrawer::StackPushWithChanceDrawer(const ITopology* topology, IColorGenerator* colorGenerator, float chanceToPushItem, float fieldFillBeforeFlush) :
	m_topology(topology),
...
StackPushWithChanceDrawer::~StackPushWithChanceDrawer() {}

void StackPushWithChanceDrawer::Draw(Field<uint32_t>& field)
{
...
bool StackPushWithChanceDrawer::TryPushPoint(const Point& point)
{
